...
class NMTModel(object):
    ...
    def __init__(self):
        ...
        self.trg_embedding = tf.Variable(tf.random_uniform([TRG_VOCAB_SIZE, HIDDEN_SIZE], -1.0, 1.0), trainable=False,
                                         name="trg_emb")
        # 定义softmax层的变量
...
def mainx(test_en_text):
    ...
    # 定义个测试句子。
    #test_en_text = "九 月 ， 有 星 孛 于 西 方 。 <eos>"
    #print(test_en_text)
